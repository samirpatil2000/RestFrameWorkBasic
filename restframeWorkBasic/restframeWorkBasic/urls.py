"""restframeWorkBasic URL Configuration
...
urlpatterns = [
   ...
   # path('post/', include('mypost.urls')),
    path('post/',  include(('mypost.urls', 'mypost'), namespace='mypost')),
    path('profile/', include(('myprofile.urls', 'myprofile'), namespace='myprofile')),
